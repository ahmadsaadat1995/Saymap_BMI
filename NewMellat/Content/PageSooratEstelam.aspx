        ...
        <div align="center" style="padding: 4px" class="box box-danger">
            ...
            <dx:ASPxGridView ID="ASPxGridView3" runat="server" AutoGenerateColumns="False" EnableTheming="True" RightToLeft="True" Theme="Office2010Silver" Width="100%" DataSourceID="sourcePishnevis" KeyFieldName="pishId" OnRowCommand="ASPxGridView3_RowCommand" Font-Names="vazir">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn ShowInCustomizationForm="False" VisibleIndex="80" Caption="ghSdate" FieldName="ghSdate" Visible="false"></dx:GridViewDataTextColumn>
                </Columns>
                <Styles>
            ...
            ,(select min(GharardadStart)  FROM [NewMellat].[dbo].[tbSooratHesab] ss  where ss.ProjectGharardad =tbSooratHesab.ProjectGharardad  and Gharardad in(N'تولید',N'پشتیبانی')) as ghSdate
		    ,(select max(GharardadEnd)  FROM [NewMellat].[dbo].[tbSooratHesab] ss  where ss.ProjectGharardad =tbSooratHesab.ProjectGharardad  and Gharardad in(N'تولید',N'پشتیبانی')) as ghEdate
...
WHERE        (paAct = 1) AND (paType = 1002) AND (paProject = @paProject)"
                            DeleteCommand="UPDATE tbProjectPaper SET paAct = 0 WHERE (paId = @paId)">
                            <DeleteParameters>
