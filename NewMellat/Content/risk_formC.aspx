<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="risk_formC.aspx.cs" Inherits="NewMellat.Content.risk_formC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <script type="text/javascript">
      function loadDoc7(parent) {
          var oWnd = radopen("PageAttach.aspx?Parent=" + parent + "&Type=23&tyExt=22,21", "RadWindow1");
          oWnd.setSize(910, 500);
          oWnd.Center();
      }
      function loadDoc2(parent) {
          var oWnd = radopen("riskInsertLetter.aspx?project=" + parent + "&Type=3", "RadWindow2");
     ...
     <div class="box box-danger">
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="Office2010Silver" AutoGenerateColumns="False" DataSourceID="source1" 
          ...
          <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" FileName="ارزش گذاری سناریو" GridViewID="ASPxGridView1">
...
from risk_form1 as r left join tbProjects as p on p.prId=r.projectId
					 ...
					 left join (select * from tbProjectPaper where paType=202)as pp on pp.paProject=p.prId
...
where [status]=2      and ((prVahed IN (SELECT prProject  FROM tbAdminProjects WHERE (prType = 3)  AND (prCode = @prCode)  )) 
