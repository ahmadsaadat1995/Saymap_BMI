        ...
        $(document).ready(function () {
            $('#searchBtn').click(function () {
               ...
               // var hadaf = $('input[name$="TextBoxHadaf"]').val();
                ...
                loadRestRequest("https://seem.bm/api/v1/symap?page=1&q="+title +"&token=E41620AA9CD0186D15ED1C20A7772DF159E8B3C7FA7684A6ED0DB1F57475336D",function (data) {
                    var html = '';
                    $.each(data.results, function (index, item) {
                        html += `<tr style="height:25px;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:silver">
                            <td></td>
                            <td>${item.Hadaf==null?'':item.Hadaf}</td>
                              <td>${item.title}</td>
                               <td>${index+1}</td>
                            </tr>`;
                    });
                    $('#myTbl tbody').html(html);
                    $('#acceptButton').show();
                });
        ...
        <div class="box box-danger" style=" padding-top: 9px;" align="right">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" align="right">
                <tr >
                    ...
                    <td align="right">
                <input id="searchBtn" type="button"  value="بررسی" />                       
                    </td>
                    <%--<td align="right">
                        <asp:TextBox ID="TextBoxHadaf" runat="server" CssClass="form-control"  Width="95%"></asp:TextBox>
                    </td>
                    <td width="12%">
                        <asp:Label ID="Label2" runat="server" Text=":هدف پروژه"></asp:Label>
                    </td>--%>
                    <td align="right">
                        <asp:TextBox ID="TextBoxTitle" runat="server" CssClass="form-control"  Width="95%"></asp:TextBox>
                    </td>
                    <td width="12%">
                ...
                <tr>
                    <td colspan="4">
                        <table style="width:100%;text-align:right" id="myTbl" >
                           <thead>
            ...
            <div style="width:100%" align="center">
                <input id="acceptButton" type="button" style="display:none;height:40px;font-size:15pt;" value="اطمینان دارم که پروژه من داخل موارد جستجو شده نیست" onclick="if (confirm('آیا مطمئن هستید')) { location.href = '/content/HN_newProject.aspx' }" />
            </div>
        </div>
    </div>
</asp:content>
