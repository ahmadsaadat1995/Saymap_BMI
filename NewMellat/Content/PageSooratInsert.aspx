    ...
    <div style="padding: 9px" class="box box-danger">
        <dx:ASPxGridView ID="ASPxGridView4" runat="server" AutoGenerateColumns="False" EnableTheming="True" OnRowCommand="ASPxGridView4_RowCommand" RightToLeft="True" Theme="Office2010Silver" Width="100%" KeyFieldName="id" OnSummaryDisplayText="ASPxGridView4_SummaryDisplayText" OnCommandButtonInitialize="ASPxGridView4_CommandButtonInitialize" OnHtmlDataCellPrepared="ASPxGridView4_HtmlDataCellPrepared" Font-Names="vazir">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="حذف" VisibleIndex="9">
                    <DataItemTemplate>
                ...
                <dx:GridViewDataTextColumn Caption="ویرایش" VisibleIndex="8">
                    <DataItemTemplate>
...
<dx:PanelContent runat="server">
    ...
    <div style="padding: 9px">
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel5" runat="server" HeaderText="استرداد" ShowCollapseButton="true" Theme="SoftOrange" Width="100%" Visible="False">
            <HeaderStyle Font-Names="vazir" HorizontalAlign="Right" />
            <PanelCollection>
<dx:PanelContent runat="server">
    <dx:ASPxGridView ID="ASPxGridView5" runat="server" AutoGenerateColumns="False" EnableTheming="True" RightToLeft="True" Theme="SoftOrange" Width="100%" OnHtmlDataCellPrepared="ASPxGridView5_HtmlDataCellPrepared" OnRowCommand="ASPxGridView5_RowCommand">
        <SettingsPager Mode="ShowAllRecords">
        </SettingsPager>
        <SettingsCommandButton>
            <EditButton ButtonType="Image">
