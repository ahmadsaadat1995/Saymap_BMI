        ...
        public BaseClientSymap(string symapLoginName){
             switch (symapLoginName)
            {
                ...
                case "hadimanesh":
                 ...
                 case "mosavi":
                      this.personID  = 872;
                    this.UserName = "0063158566";
                    break;
                 case "s.pourhashemi":
                    this.personID = 2765128;
                    this.UserName = "2709944715";
                    break;
                 case "abedini":
                    this.personID = 6415;
                    this.UserName = "419614";
                    break;
                 case "am.imani":
                    this.personID = 6193198;
                    this.UserName = "0069626871";
                    break;
                 case "ma.malmir":
                    this.personID = 1257125;
                    this.UserName = "413849";
                    break;
            }
        }
        #region Properties
