...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:SqlDataSource ID="sourceStep2" runat="server" ConnectionString="<%$ ConnectionStrings:NewMellatConnectionString %>" SelectCommand="SELECT        CONVERT(nvarchar(MAX), tbProjects.prTitle) AS prTitle, tbTarhPishnehadi.thId, tbTarhPishnehadi.thProject, tbTarhPishnehadi.thYear, tbTarhPishnehadi.thIsElhaghie,case When tbTarhPishnehadi.thIsElhaghie = 1 Then N'الحاقیه' else N'پروپوزال'end IsElhaghieValue, tbProjects.prIsMohtava, tbProjects.irIsAnalyz, 
                         ...
                         tbNazar.nzDate, tbNazar.nzShenase, DimDate.PersianStr,DimDate_1.PersianStr AS MohlatDate,tbNazar.nzNumber, tbProjects.TechnicalSuvisor As Nazer1,tbProjects.prVahed As Nazer2,prId,tbProjects.prProjectStatus
...
WHERE prProjectStatus in (N'خاتمه یافته',N'در حال اجرا',N'متوقف') and    (tbTarhPishnehadi.thAct = 1) AND (tbProjects.prIsMohtava = 0) AND (tbProjects.prEstelamIsSubmit = 1) AND (tbTarhPishnehadi.thIsCancle = 0) AND (tbProjectPaper.paAct = 1) AND (tbProjectPaper.paType = 8) AND 
