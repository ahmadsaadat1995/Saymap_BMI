<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="risk_formE.aspx.cs" Inherits="NewMellat.Content.risk_formE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <script type="text/javascript">
      function loadDoc7(parent) {
          var oWnd = radopen("PageAttach.aspx?Parent=" + parent + "&Type=26&tyExt=25,24,23,22,21", "RadWindow1");
          oWnd.setSize(910, 500);
          oWnd.Center();
      }
      function loadDoc2(parent) {
          var oWnd = radopen("riskInsertLetter.aspx?project=" + parent + "&Type=6", "RadWindow2");
...
from risk_form1 as r left join tbProjects as p on p.prId=r.projectId
					 ...
					 left join (select * from tbProjectPaper where paType in (204,205))as pp on pp.paProject=p.prId
...
where [status] in (5)     and ((prVahed IN (SELECT prProject  FROM tbAdminProjects WHERE (prType = 3)  AND (prCode = @prCode)  )) 
