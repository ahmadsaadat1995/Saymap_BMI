<%@ Page Title="" Language="C#" MasterPageFile="~/site2.Master" AutoEventWireup="true" CodeBehind="risk_formB.aspx.cs" Inherits="NewMellat.Content.risk_formB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 function loadDoc7(parent) {
     var oWnd = radopen("PageAttach.aspx?Parent=" + parent + "&Type=21&tyExt=22", "RadWindow1");
             oWnd.setSize(910, 500);
             oWnd.Center();
 }
 function loadDoc2(parent) {
     var oWnd = radopen("riskInsertLetter.aspx?project=" + parent + "&Type=2", "RadWindow2");
...
where [status]=1      and ((prVahed IN (SELECT prProject  FROM tbAdminProjects WHERE (prType = 3)  AND (prCode = @prCode)  )) 
